...
namespace Player.States
{
    internal class PlayerStateCharging : PlayerBaseState
    {
        ...
        public override void OnEnterState()
        {
            ...
            SoundManager.Instance.PlaySound(SoundManager.SoundType.Sfx, "slingshot_sound1",
        ...
        public override void OnUpdateState()
        {
            ...
            Controller.PlayerStatus.ConsumeStamina(Controller.PlayerStatus.ChargeStaminaComsumptionPerSec *
                Time.deltaTime / ts);
