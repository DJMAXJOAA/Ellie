...
namespace UI.Interactive
{
    public class InteractiveCanvasTestClient : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                ticketMachine.SendMessage(ChannelType.UI,
                    Make(ActionType.PopupInteractive, InteractiveType.Acquisition));
            }
            ...
            {
                ticketMachine.SendMessage(ChannelType.UI,
                    Make(ActionType.CloseInteractive, InteractiveType.Acquisition));
            }
        }
