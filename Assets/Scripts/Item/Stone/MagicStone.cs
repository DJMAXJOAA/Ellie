...
namespace Item.Stone
{
    ...
    {
        public static bool isActivateRange;
        ...
        {
            var hitColliders = Physics.OverlapSphere(transform.position, attractionRadiusRange, bossLayer);
